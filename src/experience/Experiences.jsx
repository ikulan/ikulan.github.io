...
const expObjs = [
  {
    ...
    descriptions: [
      "Developed the SaaS web application of an influencer marketing management and analytics software using Ruby.",
      "Designed and implemented RESTful API, leveraging MongoDB to store and process the high-volume social media data.",
      "Worked collaboratively with the design and product teams to craft comprehensive analytics and reporting features through the use of JavaScript, jQuery, and D3.js.",
  ...
  },
  {
    ...
    descriptions: [
      "Developed the large-scale data processing pipeline for a social listening system using Java. Supported multi-lingual NLP processing on millions of social media posts per hour.",
      "Collaborated with Linguists colleagues to develop the rule-based NLP engine. Transformed XML rules into programmable logics, efficiently applying to text data across 27 deep parsing languages.",
